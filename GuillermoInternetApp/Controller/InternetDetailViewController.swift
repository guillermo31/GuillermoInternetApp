...
//  GuillermoInternetApp
//
//  Created by Ramos aguirre, Guillermo on 12/14/18.
...
class InternetDetailViewController: UIViewController
{
    ...
    {
        if let contentPDF = Bundle.main.url(forResource: "Internet Screen", withExtension: "pdf", subdirectory: nil, localization: nil)
        {
